...
## Exceptions
* Exceptions are now dismissible either by choosing to ignore them OR resolving them. You can see a log of exceptions resolved in the report on the Reports page. 
