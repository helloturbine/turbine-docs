...
## Exceptions
* Exceptions are now dismissable either by choosing to ignore them OR resolving them. You can see a log of excdptions resolved in the report on the Reports page. 
...
* Bug squash: If we can save a remoteSKU because it's a duplicate, you'll now see an error.
